var App = function () {
	...
	var handleBackstretch = function () {
		 $.backstretch([
		  "../../static/drg/img/login/1.jpg"
		, "../../static/drg/img/login/2.jpg"
		, "../../static/drg/img/login/3.jpg"
		, "../../static/drg/img/login/4.jpg"
	...
	var handleTimeline = function () {
		createStoryJS({
			...
			width:		'100%',
			height:		'600',
			source:		'../../static/drg/js/timelinejs/example_json.json',
			embed_id:	'my-timeline',
			debug:		true,
			css:        '../../static/drg/js/timelinejs/css/timeline.css',     
            js:         '../../static/drg/js/timelinejs/js/timeline-min.js'    
		});
	}
	/*-----------------------------------------------------------------------------------*/
	/*	Handle Slidernav
	...
	var handleThemeSkins = function () {
        ...
        var setSkin = function (color) {
            $('#skin-switcher').attr("href", "../../static/drg/css/themes/" + color + ".css");
	...
	return {
        ...
        blockUI: function (el, loaderOnTop) {
            lastBlockedUI = el;
            jQuery(el).block({
                message: '<img src="../../static/drg/img/loaders/12.gif" align="absmiddle">',
                css: {
                    border: 'none',
                    padding: '2px',
